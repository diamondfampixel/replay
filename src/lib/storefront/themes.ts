...
const PREMIUM: CatalogTheme[] = [
  {
    ...
    features: ["Drop countdown (poster)", "Lookbook filmstrip", "Video hero", "Three custom section schemes", "Asymmetric grid + poster product", "Story steps", "Stats band", "Transparent split header", "Parallax + blur reveal", "Immersive product page"],
    ...
    recipe: [{ type: "videoHero", always: true, config: { height: "screen" } }, { type: "dropCountdown", layout: "poster", always: true, config: { eyebrow: "Drop 02", headline: "The next drop lands soon", ctaLabel: "Notify me" }, design: d("custom", { customScheme: "smoke" }) }, { type: "marquee", config: { items: [{ text: "Drop 01" }, { text: "Limited" }, { text: "Worldwide" }], size: "xl" }, design: d("custom", { customScheme: "acid" }) }, { type: "featuredProducts", layout: "asymmetric", config: { limit: 5 } }, { type: "story", layout: "steps", always: true, config: { heading: "The process" } }, { type: "lookbook", layout: "filmstrip", always: true, config: { heading: "On the street" }, design: d("custom", { customScheme: "smoke" }) }, { type: "featuredProduct", layout: "poster", design: d("custom", { customScheme: "bone" }) }, { type: "stats", layout: "inline", always: true }, { type: "collectionGrid", layout: "mosaic" }, { type: "newsletter", layout: "banner", design: d("custom", { customScheme: "acid" }) }],
  ...
  },
  {
    ...
    features: ["Editorial lookbook", "Materials & care spec sheet", "Editorial product page", "Campaign editorial hero", "Linen + noir custom schemes", "Narrow 1040px page", "Editorial quote with portrait", "Transparent centered header", "115% heading scale", "Immersive product page", "Fade reveal only"],
    theme: { direction: "luxury", accent: "#1f1b17", neutral: "warm", dna: { expression: 40, density: 12, edge: 95 }, typography: { display: "cormorant", body: "jost", headingScale: 1.15, headingTransform: "uppercase", headingTracking: 0.1 }, schemes: [{ id: "linen", name: "Linen", background: "#efe8dc", foreground: "#1f1b17" }, { id: "noir", name: "Noir", background: "#141210", foreground: "#efe8dc", accent: "#c9b48a" }], layout: { width: "narrow", density: "spacious", sectionSpacing: "airy" }, headerConfig: { style: "transparent", navUppercase: true, logoSize: "lg" }, footer: { style: "centered", scheme: "base" }, product: { layout: "editorial", imageRatio: "tall" }, cards: { ratio: "tall", hover: "zoom", align: "center", priceEmphasis: "muted" }, motionConfig: { level: "subtle", reveal: "fade", parallax: false } },
    recipe: [{ type: "hero", layout: "editorial", config: { headingSize: "xl" }, design: d("custom", { customScheme: "linen", paddingTop: "xl" }) }, { type: "lookbook", layout: "editorial", always: true, config: { heading: "The collection", intro: "Shot on location. Every look links to the piece." } }, { type: "text", layout: "statement", design: d("muted") }, { type: "featuredProducts", layout: "editorial", config: { limit: 3 } }, { type: "specSheet", layout: "table", always: true, config: { heading: "Materials & care", intro: "What each piece is made of, and how it should be kept." }, design: d("custom", { customScheme: "linen" }) }, { type: "quote", layout: "editorial" }, { type: "collectionGrid", layout: "list" }, { type: "newsletter", layout: "centered" }],
  ...
  },
  {
    ...
    features: ["Kitchen lookbook filmstrip", "Flavour drop countdown", "Three rotating candy schemes", "Gallery mosaic", "Product carousel", "Benefit cards", "Circle collections", "Pill buttons + XL radius", "Elevated lift cards", "Gallery product page"],
    ...
    recipe: [{ type: "announcement", layout: "marquee", config: { background: "brand" }, always: true }, { type: "hero", layout: "center", config: { headingSize: "display" }, design: d("custom", { customScheme: "berry" }) }, { type: "marquee", config: { items: [{ text: "Sours" }, { text: "Gummies" }, { text: "Chocolate" }, { text: "Fizz" }], size: "lg" } }, { type: "featuredProducts", layout: "carousel", config: { limit: 8 } }, { type: "lookbook", layout: "filmstrip", always: true, config: { heading: "Fresh from the kitchen", intro: "This week's batches, as they came out." }, design: d("custom", { customScheme: "lemon" }) }, { type: "benefits", layout: "cards", always: true }, { type: "dropCountdown", layout: "banner", always: true, config: { eyebrow: "Limited batch", headline: "Next flavour drops soon", ctaLabel: "Save me one" }, design: d("custom", { customScheme: "berry" }) }, { type: "collectionGrid", layout: "circles" }, { type: "faq", layout: "accordion" }, { type: "newsletter", layout: "split" }],
  ...
  },
  {
    ...
    features: ["Ingredient spec cards", "Field lookbook", "Timeline story", "Quote card", "Benefit rows", "Moss + clay custom schemes", "Swap-hover portrait cards", "Details accordion on product page", "Brand footer with newsletter", "Subtle motion, no parallax"],
    ...
    recipe: [{ type: "hero", layout: "split" }, { type: "text", layout: "eyebrow", design: d("custom", { customScheme: "clay" }) }, { type: "specSheet", layout: "cards", always: true, config: { heading: "What's inside", intro: "Every ingredient, where it comes from, and why it is there." } }, { type: "story", layout: "timeline", always: true }, { type: "featuredProducts", layout: "grid", config: { columns: 3 } }, { type: "benefits", layout: "rows", always: true }, { type: "lookbook", layout: "stacked", always: true, config: { heading: "From the field" }, design: d("custom", { customScheme: "clay" }) }, { type: "quote", layout: "card" }, { type: "collectionGrid", layout: "list" }, { type: "newsletter", layout: "centered" }],
  ...
  },
  {
    ...
    features: ["Compare-models spec table", "Release countdown", "Graphite + signal custom schemes", "Stats grid + value props", "Poster product", "Two-column FAQ", "Glass surfaces", "Framed landscape cards", "Sticky-info product page", "Balanced stagger motion"],
    ...
    recipe: [{ type: "announcement", layout: "static", config: { background: "brand" }, always: true }, { type: "hero", layout: "split", design: d("custom", { customScheme: "graphite" }) }, { type: "valueProps", layout: "grid", always: true }, { type: "specSheet", layout: "compare", always: true, config: { heading: "Compare models", columns: ["Standard", "Pro"] }, design: d("custom", { customScheme: "graphite" }) }, { type: "stats", layout: "grid", always: true }, { type: "featuredProducts", layout: "grid", config: { columns: 4 } }, { type: "featuredProduct", layout: "poster" }, { type: "dropCountdown", layout: "banner", always: true, config: { eyebrow: "Next release", headline: "New hardware, on a date", ctaLabel: "Get the alert" } }, { type: "imageText", layout: "split" }, { type: "faq", layout: "twoColumn" }, { type: "newsletter", layout: "inline" }],
  ...
  },
  {
    ...
    features: ["Stacked lookbook", "Editorial product page", "Masonry gallery", "Editorial image hero", "Full-width image", "Tall grid", "Paper custom scheme for the statement", "Hairline chrome", "Gallery product page"],
    theme: { direction: "minimal", accent: "#f2f1ee", neutral: "ink", dna: { expression: 25, density: 30 }, typography: { display: "manrope", body: "manrope", headingScale: 0.9 }, schemes: [{ id: "paper", name: "Paper", background: "#efece4", foreground: "#161616" }], surface: { borderWidth: 1 }, headerConfig: { style: "minimal", logoSize: "sm" }, footer: { style: "minimal", scheme: "base" }, product: { layout: "editorial", imageRatio: "tall" }, cards: { ratio: "tall", hover: "zoom", priceEmphasis: "muted" }, shape: { radius: "none" } },
    recipe: [{ type: "imageHero", layout: "editorial", always: true }, { type: "lookbook", layout: "stacked", always: true, config: { heading: "", intro: "" } }, { type: "gallery", layout: "masonry", always: true }, { type: "featuredProducts", layout: "grid", config: { columns: 3, limit: 6 } }, { type: "fullImage", always: true }, { type: "text", layout: "statement", design: d("custom", { customScheme: "paper" }) }, { type: "newsletter", layout: "inline" }],
  ...
  },
  {
    ...
    features: ["Good-to-know spec table", "Collection hero", "Six-collection mosaic", "Best-sellers list", "Saffron custom scheme", "Dense five-column grid", "Filters + counts on", "Compact spacing", "Media-left product page"],
    ...
    recipe: [{ type: "announcement", layout: "marquee", always: true }, { type: "collectionHero", layout: "banner" }, { type: "collectionGrid", layout: "mosaic" }, { type: "featuredProducts", layout: "grid", config: { columns: 4, limit: 8 } }, { type: "specSheet", layout: "table", always: true, config: { heading: "Good to know", intro: "Shipping, returns and sizing at a glance." }, design: d("muted") }, { type: "benefits", layout: "icons", always: true }, { type: "featuredProducts", layout: "list", config: { limit: 4 } }, { type: "newsletter", layout: "banner" }],
