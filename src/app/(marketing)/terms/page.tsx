...
export default function TermsPage() {
  return (
    <main className="mx-auto max-w-2xl px-5 py-16">
      <h1 className="text-[28px] font-semibold tracking-[-0.02em] text-ink-900">Terms of service</h1>
      ...
      <div className="mt-8 space-y-6 text-[14.5px] leading-relaxed text-ink-700">
        <section>
          <h2 className="text-[17px] font-semibold text-ink-900">The service</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-[17px] font-semibold text-ink-900">Your account and plan</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-[17px] font-semibold text-ink-900">Acceptable use</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-[17px] font-semibold text-ink-900">Your data</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-[17px] font-semibold text-ink-900">Warranty and liability</h2>
          <p className="mt-2">
